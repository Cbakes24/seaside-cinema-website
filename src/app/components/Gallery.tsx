      ...
      try {
        ...
        if (customImages) {
          ...
          const publicImages: GalleryImage[] = [
            ...
            { src: '/largeBali3.JPG', alt: 'Large Bali 3', filename: 'largeBali3.JPG' },
            ...
            { src: '/largeBali2.PNG', alt: 'Large Bali 2', filename: 'largeBali2.PNG' },
            ...
            { src: '/L_bday_classic.jpeg', alt: 'L Birthday Classic', filename: 'L_bday_classic.jpeg' },
            { src: '/Kids_birthday_photoshopped.png', alt: 'Kids Birthday Photoshopped', filename: 'Kids_birthday_photoshopped.png' },
            { src: '/Kids_birthday_2photoshopped.png', alt: 'Kids Birthday 2 Photoshopped', filename: 'Kids_birthday_2photoshopped.png' },
            { src: '/sunsetOrange.png', alt: 'Sunset Orange', filename: 'sunsetOrange.png' },
            { src: '/heartstring.png', alt: 'Heart String', filename: 'heartstring.png' },
