...
// // import FallNostalgiaSection from '../components/FallNostalgiaSection';
...
//               (experience: { id: string; name: string; price: number; description: string; image: string, includes: string[] }, i: number) => (
